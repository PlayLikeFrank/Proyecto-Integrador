...
<head>
    ...
    <title>Pantalla de invitado</title>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <a href="invitadomp.php" class="btn btn-view">Ver Datos</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <a href="invitadopaciente.php" class="btn btn-view">Ver Datos</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <a href="invitadomedico.php" class="btn btn-view">Ver Datos</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <a href="invitadobodega.php" class="btn btn-view">Ver Datos</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <a href="invitadofarmacia.php" class="btn btn-view">Ver Datos</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        <p class="card-text" class="let">Cerrar sesión del Invitado.</p>
