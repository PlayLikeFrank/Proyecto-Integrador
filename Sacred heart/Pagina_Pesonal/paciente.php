    ...
    <div class="table-responsive">
        ...
        <tbody>
          ...
          while ($row8 = mysqli_fetch_assoc($res8)) {
            ...
            <tr>
              ...
              <td scope="row">
                <!-- <a class="btn btn-secondary" href="actualizarpa.php?codigo=<?php echo $row8['ID_Paciente']; ?>">Actualizar</a> -->
                <a class="btn btn-secondary btn-sm"
                  href="actualizarpa.php?codigo=<?php echo $row8["ID_Paciente"]; ?>">Actualizar</a>
                <a class="btn btn-dark" href="eliminarpa.php?Codigo=<?php echo $row8['ID_Paciente']; ?>">Eliminar</a>
      ...
      <div class="text-center mt-3">
        ...
        if (isset($_SESSION["USER"]) && $_SESSION["USER"] == "admin") {
          ...
          echo "<a href='agregarpa.php' class='btn btn-info' >Insertar</a> &emsp;";
