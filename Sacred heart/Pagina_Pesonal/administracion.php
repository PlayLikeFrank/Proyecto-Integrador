    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <a class="btn btn-insert" href="admin.php">Insertar</a>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <a class="btn btn-insert" href="agregarpa.php">Insertar</a>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text" class="let">Gestión de Notas</p>
                        <div class="btn-group">
                            <a href="notaP.php" class="btn btn-insert">Insertar</a>
                            <a href="nota.php" class="btn btn-view">Ver Datos</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        <p class="card-text" class="let">Cerrar sesión</p>
                        <a href="log.php" class="btn btn-exit">Salir</a>
                    </div>
                </div>
            </div>
        </div>
