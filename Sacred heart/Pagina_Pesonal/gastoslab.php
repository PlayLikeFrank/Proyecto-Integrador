...
<div class="container text-center">
    <h2 class="header">Gastos en laboratorio </h2>
  </div>
  ...
  <div class="container table-container">
    <div class="table-responsive">
      <table class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                            <?php 
                                $s8="SELECT * FROM gastos_lab";
                                $res8=mysqli_query($con,$s8);
                                while ($row8= mysqli_fetch_assoc($res8)) {
                            ?>
                            <tr>
                            <td scope="row"><?php echo $row8['ID_G_LAB']?></td>
                            <td scope="row"><?php echo $row8['Descripcion_Lab'] ?></td>
                            <td scope="row"><?php echo $row8['Gastos_L'] ?></td>
                          
                             <td scope="row"><a class="btn btn-secondary" href="actualizarlab.php?codigo=<?php echo $row8['ID_G_LAB']; ?>">Modificar</a>
                            <a  class="btn btn-dark" href="eliminarlab.php?Codigo=<?php echo $row8['ID_G_LAB']; ?>">Eliminar</a></td> 
                            </tr>
                        <?php
                            }
                        ?>
                    ...
                    <a  class="btn btn-secondary"href="agregarlab.php">Agregar</a></td>
            </div>
        </div>
