            ...
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-secondary btn-sm"
                  href="actualizarp.php?codigo=<?php echo $row9["ID_P_Cargo"]; ?>">Actualizar</a>
                <a class="btn btn-dark btn-sm" href="eliminarp.php?Codigo=<?php echo $row9['ID_P_Cargo']; ?>">Eliminar</a>
