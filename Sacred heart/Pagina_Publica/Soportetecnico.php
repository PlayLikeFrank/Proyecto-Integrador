...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .main-container {
      min-height: calc(100vh - 120px); /* altura total menos nav + footer */
      display: flex;
      align-items: center;
...
<body>
  ...
  <nav class="menu">
    <h1 class="let2 mb-2 mb-md-0">Soporte Técnico</h1>
    <ul class="nav-links">
  ...
  <div class="main-container">
    <div class="form-container">
      <h4>Formulario de Soporte Técnico</h4>
      <form>
        <div class="mb-3">
        ...
        <div class="mb-3 form-check">
          ...
          <label class="form-check-label">Acepto los términos de uso y privacidad.</label>
        </div>

        <div class="d-grid">
         <button id="btnEnviar" type="button" class="btn btn-help">Enviar solicitud</button>
        </div>
      </form>
    </div>
  </div>
