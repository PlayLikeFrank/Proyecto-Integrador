...
<body>
      ...
      <form>
        ...
        <div class="mb-3">
          <label for="consulta" class="form-label">
            Comentarios, sugerencias u otro tipo de consulta
          </label>
          <textarea id="consulta" class="form-control" rows="4" required></textarea>
        </div>

        <div class="mb-3 form-check">
          <input type="checkbox" id="confirmacion" class="form-check-input" required>
          <label for="confirmacion" class="form-check-label">
            Confirmo que mi consulta no es de soporte técnico.
          </label>
        </div>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    btn.addEventListener('click', function () {
      ...
      btn.disabled = true; // desactiva para que no lo pulsen más
